...
?>
<div class='mfp-hide form-skip-cancel form-cancel form-sm-cancel-2' id="form-sm-cancel-2">
        ...
        <div class="form-select-trade-left">
          <div class="form-select-trade-content">
            <div class="select-trade-content">
              ...
              <a href="#" class="trade_action trade_kissme btn-secondary btn-solid condensed btn-static transparent">Trade this month’s palette</a>
            </div>
          </div>
        </div>
