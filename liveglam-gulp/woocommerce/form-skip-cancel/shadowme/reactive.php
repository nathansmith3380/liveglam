...
?>
<div class='mfp-hide form-skip-cancel form-reactive form-sm-reactive' id="form-sm-reactive">
  ...
  <div class="form-skip-cancel-footer text-center">
    <div class="form-content">
      <div class="single-action">
        <a href="<?php echo $link_reactive_sm; ?>" class="btn-action btn-primary condensed btn-static">Continue to Reactivate</a>
