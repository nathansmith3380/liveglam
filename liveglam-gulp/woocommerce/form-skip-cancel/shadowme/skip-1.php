...
?>
<div class='mfp-hide form-skip-cancel form-skip form-sm-skip-1' id="form-sm-skip-1">
      ...
      <div class="form-skip-explain">
        <div class="form-skip-explain-left hide-mobile">
          <div class="form-skip-explain-content">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/form-skip-cancel-sm-badge-skip.png" alt="Image Badge Skip"/>
          </div>
        </div>
        <div class="form-skip-explain-right">
          <div class="form-skip-explain-content">
            <div class="explain-content">
              <p class="explain-title">If you skip a month of ShadowMe:</p>
              <p class="explain-lists">You will not make your next payment</p>
              <p class="explain-lists">You will not receive your next palette</p>
