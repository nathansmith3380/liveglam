...
?>
<div class='mfp-hide form-skip-cancel form-cancel form-km-cancel-2' id="form-km-cancel-2">
  <div class="form-skip-cancel-head text-center">
    <div class="form-content">
      <p class="title">Would you Rather Trade Your Lippies?</p>
      <p class="description">You can easily replace your next set of lippies with some of these awesome alternatives for no additional cost.</p>
    </div>
  </div>
        ...
        <div class="form-select-trade-left">
          <div class="form-select-trade-content">
            <div class="select-trade-content">
              ...
              <a href="#" class="trade_action trade_kissme btn-secondary btn-solid condensed btn-static transparent">Trade this month’s lippies</a>
            </div>
          </div>
        </div>
