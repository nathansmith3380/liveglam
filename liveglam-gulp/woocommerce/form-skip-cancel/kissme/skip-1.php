...
?>
<div class='mfp-hide form-skip-cancel form-skip form-km-skip-1' id="form-km-skip-1">
      ...
      <div class="form-skip-explain">
        <div class="form-skip-explain-left hide-mobile">
          <div class="form-skip-explain-content">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/form-skip-cancel-km-badge-skip.png" alt="Image Skip"/>
          </div>
        </div>
        <div class="form-skip-explain-right">
          <div class="form-skip-explain-content">
            <div class="explain-content">
              <p class="explain-title">If you skip a month of KissMe:</p>
              <p class="explain-lists">You will not make your next payment</p>
              <p class="explain-lists">You will not receive your next lippies</p>
