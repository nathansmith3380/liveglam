...
?>
<div class='mfp-hide form-skip-cancel form-cancel form-mm-cancel-1' id="form-mm-cancel-1">
  <div class="form-skip-cancel-head text-center">
    <div class="form-content">
      <p class="title">Are You Sure You Want To Cancel?</p>
      <p class="description"><?php echo $display_name; ?>, look how close you are to earning some amazing prizes! If you cancel, you will lose <?php echo (!empty($points_related_to_mm) && $points > $points_related_to_mm)?$points_related_to_mm:'all your';?> points!</p>
    </div>
  </div>
  <div class="form-cancel-show-points">
    <img class="hide-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/form-skip-cancel-banner-cancel.jpg" alt="MorpheMe Image"/>
    <img class="show-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/form-skip-cancel-banner-cancel-mb.jpg" alt="MorpheMe Image"/>
