...
?>
<div class='mfp-hide form-skip-cancel form-cancel form-mm-cancel-4' id="form-mm-cancel-4">
  ...
  <div class="form-skip-cancel-body">
    <div class="form-content">
      <div class="form-confirmation">
        <div class="form-confirmation-reason">
          <div class="form-reason">
            ...
            <div class="reason-lists hide-mobile">
              <label for="mm-cancel-reason-list-1">
                <input type="radio" name="submit-reason" class="submit-reason" id="mm-cancel-reason-list-1" value="I don’t like this month’s brushes"/>I don’t like this month’s brushes
              </label>
              <label for="mm-cancel-reason-list-2">
                <input type="radio" name="submit-reason" class="submit-reason" id="mm-cancel-reason-list-2" value="I can’t afford it right now"/>I can’t afford it right now
              </label>
              <label for="mm-cancel-reason-list-3">
                <input type="radio" name="submit-reason" class="submit-reason" id="mm-cancel-reason-list-3" value="I don’t like the brush variety"/>I don’t like the brush variety
              </label>
              <label for="mm-cancel-reason-list-4">
                <input type="radio" name="submit-reason" class="submit-reason" id="mm-cancel-reason-list-4" value="I am unhappy with my experience"/>I am unhappy with my experience
              </label>
              <label for="mm-cancel-reason-list-5">
                <input type="radio" name="submit-reason" class="submit-reason" id="mm-cancel-reason-list-5" value="I have too many brushes"/>I have too many brushes
              </label>
              <label for="mm-cancel-reason-list-6">
                <input type="radio" name="submit-reason" class="submit-reason" id="mm-cancel-reason-list-6" value="I have personal reasons"/>I have personal reasons
              </label>
            </div>
            <div class="reason-selected show-mobile">
              <label class="d-none" for="mm-submit-reason-cancel">&nbsp;</label>
              <select class="submit-reason form-control selectpicker" id="mm-submit-reason-cancel">
                <option value="" selected="selected" disabled>I want to cancel because ...</option>
                <option value="I don’t like this month’s brushes">I don’t like this month’s brushes</option>
                <option value="I can’t afford it right now">I can’t afford it right now</option>
                <option value="I don’t like the brush variety">I don’t like the brush variety</option>
                <option value="I am unhappy with my experience">I am unhappy with my experience</option>
                <option value="I have too many brushes">I have too many brushes</option>
        ...
        <?php if($active_type_mm == 'monthly'){ ?>
          <p class="form-confirmation-notice mm-form-confirmation-notice">FYI! If you cancel your membership and want to reactivate within 30 days, you will not have the option for a free product at checkout!</p>
        <?php } ?>
