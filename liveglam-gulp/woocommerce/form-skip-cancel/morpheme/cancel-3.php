...
?>
<div class='mfp-hide form-skip-cancel form-cancel form-mm-cancel-3' id="form-mm-cancel-3">
  <div class="form-skip-cancel-head text-center">
    <div class="form-content">
      ...
      <p class="description">You might not like this month’s brushes, but you don’t have to cancel.</p>
    </div>
  </div>
    ...
    <div class="form-content">
      <div class="form-wanna-skip">
        ...
        <div class="wanna-skip-action show-mobile">
          <a href="#" class="skip_a_month skip_month_mm btn-secondary btn-solid transparent btn-static">Skip one month</a>
        </div>
