...
?>
<div class='mfp-hide form-skip-cancel form-reactive form-mm-reactive' id="form-mm-reactive">
  ...
  <div class="form-skip-cancel-footer text-center">
    <div class="form-content">
      <div class="single-action">
        <a href="<?php echo $link_reactive_mm; ?>" class="btn-action btn-primary condensed btn-static">Continue to Reactivate</a>
