<?php
  /**
   * Template Name: Rewards page Diamond Elite
   *
   * @package Liveglam
   */
  ...
  <section class="message_text">
    <div class="wrap">
      <p class="notice_title"> Hey
        <span class="user_diamond"><?php echo $user->first_name; ?></span>! You will earn $7 - $10 for every friend that signs up to any of our clubs using your affiliate referral code!
      </p>
    </div>
  </section>
    ...
    <div class="wrap hide-mobile">
      <div class="section-title">
        ...
        <div class="section-tier">Your Tier: <?php echo ucwords($userLevel); ?>
          <img alt="Diamond Elite" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-reward-tier-diamond-elite.png" /></div>
      </div>
    </div>
...
<script type="text/javascript">
  jQuery(document).ready(function () {
    ...
    membership_tier_slider.trigger('to.owl.carousel',3);
