  ...
  <div class="homepage-hero">
    <div class="container">
      <div class="flex-group">
        <div class="content">
          <div class="newmonthnewyou d-desktop">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/newmonthnewyou.png" alt="LiveGlam New Month New You">
          </div>
          <div class="newmonthnewyou d-mobile">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/newmonthnewyou-m.png" alt="LiveGlam New Month New You">
          </div>
          <div class="text nd19-section-subtitle">Join the
            <strong>#LiveGlamFam</strong> and choose from lippies, brushes and palettes for $19.99!
          </div>
  ...
  <div class="homepage-liveglamfam">
    <div class="container">
      ...
      if ( !empty($liveglamfam_slider = get_field('liveglamfam_slider')) ): ?>
        ...
        <?php endif; ?>
      <div class="section-cta"><a href="<?php echo home_url(PAGE_PRE_CHECKOUT); ?>" class="btn-primary">join the fam</a>
      </div>
    </div>
  </div>
  <!-- End LiveGlamFam Section -->
        ...
        'post_status' => 'publish'
          ...
          if($blog_query->have_posts()) :
            while($blog_query->have_posts()) : $blog_query->the_post();
              $all_blogs[] = array(
                'image' => get_the_post_thumbnail_url(null, 'shop_catalog'), 'categories' => get_the_category_list(', '), 'title' => get_the_title(), 'link' => esc_url(get_the_permalink())
              );
            endwhile;
            wp_reset_postdata();
          endif; ?>
