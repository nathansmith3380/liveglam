<?php
  /**
   * Template Name: Confirmation MorpheMe JoinIn
   *
   * @package Liveglam
   */
...
?>
  ...
  <section class="subscribe-confirmation auto-height detail-confirmation">
    <div class="banner-order-confirm">
      <img class="hide-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/confirm2019-joinin-mm.png" alt="MorpheMe Confirm Image">
      <img class="show-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/confirm2019-joinin-mm1.png" alt="MorpheMe Confirm Image">
    </div>
    <div class="new-confirm-page flex-group confirm-joinin2019">
      <div class="new-confirm-page-left">
        <div class="new-confirm-main">
          ...
          <p class="new-confirm-desc2019 hide-mobile">We're so excited for you to get your first package! You're going to love your new goodies. FYI - Your brushes are being prepped and will be en route to you within <strong>2 business days.</strong></p>
          <p class="new-confirm-desc2019 show-mobile">Hey <?php echo $order->get_billing_first_name(); ?>! We're so excited for you to get your first package! You're going to love your new goodies. FYI - Your brushes are being prepped and will be en route to you within <strong>2 business days.</strong></p>
