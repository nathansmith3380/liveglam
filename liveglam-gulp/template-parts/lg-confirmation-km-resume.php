<?php
/**
 * Template Name: Confirmation KissMe Resume
 *
 * @package Liveglam
 */
...
?>
  ...
  <section class="subscribe-confirmation auto-height detail-confirmation">
    <div class="banner-order-confirm">
      <img class="hide-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/confirm2019-resume-km.png" alt="KissMe Confirm Image">
      <img class="show-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/confirm2019-resume-km1.png" alt="KissMe Confirm Image">
    </div>
    <div class="new-confirm-page flex-group confirm-joinin2019">
      <div class="new-confirm-page-left">
        <div class="new-confirm-main">
          ...
          <p class="new-confirm-desc2019 hide-mobile">Thank you for rejoining KissMe! It's always great to have you here! FYI - Your lippies are being prepped and will be en route to you within <strong>2 business days.</strong></p>
          <p class="new-confirm-desc2019 show-mobile">Hey <?php echo $order->get_billing_first_name(); ?>! Thank you for rejoining KissMe! It's always great to have you here! FYI - Your lippies are being prepped and will be en route to you within <strong>2 business days.</strong></p>
