<?php
  /**
   * Template Name: Confirmation KissMe JoinIn
   *
   * @package Liveglam
   */
...
if(false === ($order = wc_get_order($order_id))){
  ...
  switch($productID){
    case KM_MONTHLY: $orderType = '1 month'; break;
    case KM_SIXMONTH: $orderType = '6 months'; break;
    case KM_ANNUAL: $orderType = '12 months'; break;
  }
  ...
  $order_details = lgs_order_detail_items($order, 'kissme');

?>

  <section class="subscribe-confirmation auto-height detail-confirmation">
    <div class="banner-order-confirm">
      <img class="hide-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/confirm2019-joinin-km.png" alt="KissMe Confirm Image">
      <img class="show-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/confirm2019-joinin-km1.png" alt="KissMe Confirm Image">
    </div>
    <div class="new-confirm-page flex-group confirm-joinin2019">
      <div class="new-confirm-page-left">
        <div class="new-confirm-main">
          ...
          <p class="new-confirm-desc2019 hide-mobile">We're so excited for you to get your first package! You're going to love your new goodies. FYI - Your lippies are being prepped and will be en route to you within <strong>2 business days.</strong></p>
          <p class="new-confirm-desc2019 show-mobile">Hey <?php echo $order->get_billing_first_name(); ?>! We're so excited for you to get your first package! You're going to love your new goodies. FYI - Your lippies are being prepped and will be en route to you within <strong>2 business days.</strong></p>
            ...
            <div class="order-details2019">
              <div class="order-details2019-content">
                <div class="order-details2019-item colspan3 content-inline">
                  <p class="order-details2019-desc mt-0 ml-0 mr-0 mb-0">KissMe Subscription - <?php echo $orderType; ?></p>
