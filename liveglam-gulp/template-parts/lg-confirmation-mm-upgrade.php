<?php
/**
 * Template Name: Confirmation MorpheMe Upgrade
 *
 * @package Liveglam
 */
  ...
  foreach ($order->get_items() as $item ){
    if( $item['product_id'] == LG_SIXMONTH ){
      $orderPoints = 100; break;
    }
    if( $item['product_id'] == LG_ANNUAL ){
  ...
  <section class="subscribe-confirmation auto-height new-confirm-page flex-group upgrade-confirmation">
    <div class="new-confirm-page-left no-padding">
      <div class="new-confirm-main">
        <img class="bg-image hide-mobile" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/confirm2019-upgrade-mm.png" alt="Image Background">
    ...
    <div class="new-confirm-page-right">
      <div class="new-confirm-main">
        ...
        <div class="new-share2019 new-share2019-shipping mm-bg">
          <div class="new-share2019-content">
            ...
            <p class="new-share2019-subtitle">Now that you've upgraded, your shipment dates haven't changed. Your next set of brushes will ship <?php echo date("M d, Y", strtotime("+1 months + 1 day", time())); ?></p>
        ...
        <div class="new-share2019 new-share2019-rewards mm-bg">
          <div class="new-share2019-content">
